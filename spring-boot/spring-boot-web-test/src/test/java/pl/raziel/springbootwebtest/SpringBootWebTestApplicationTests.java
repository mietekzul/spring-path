package pl.raziel.springbootwebtest;
...
import pl.raziel.springbootwebtest.domain.JournalEntry;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(classes = SpringBootWebTestApplicationTests.class)
@WebAppConfiguration
